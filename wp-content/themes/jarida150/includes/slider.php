...
<?php if( $slider_query != 'custom' ): ?>		
	...
	<div id="ei-slider" class="ei-slider">
		...
		<?php $i= 0;
			while ( $featured_query->have_posts() ) : $featured_query->the_post(); $i++; ?>
			<li><a href="#">Slide <?php echo $i; ?></a><img src="<?php echo tie_thumb_src('',300,160); ?>" alt="<?php the_title(); ?>" /></li>
    		<?php endwhile;?>
		</ul><!-- ei-slider-thumbs -->
	</div>
	<?php endif; ?>
	...
	<div id="ei-slider" class="ei-slider">
		...
		<?php $i= 0;
		 ...
		 <ul class="ei-slider-thumbs">
			...
			<li><a href="#">Slide <?php echo $i; ?></a><img src="<?php echo tie_slider_img_src($slide['id'] ,300,160); ?>" alt="<?php  echo stripslashes( $slide['title'] )  ?>" /></li>
			<?php endforeach; ?>
