...
function tie_most_viewed_posts($pop_posts = 5 , $thumb = true){
	...
	$cat_query1 = new WP_Query(array('posts_per_page' => $pop_posts, 'orderby' => 'meta_value_num' ,  'meta_key' => 'tie_views', 'post_status' => 'publish'));
	...
	<?php else: ?>
		<div id="login-form">
			...
			<ul class="login-links">
				...
				<li><a href="<?php echo wp_lostpassword_url( get_permalink() ); ?>"><?php _e( 'Lost your password?' , 'tie' ) ?></a></li>
			</ul>
		</div>
	<?php endif;
}
