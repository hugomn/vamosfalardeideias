...
body{
	background:<?php if( !empty($bg['color']) ) echo $bg['color']; else echo "#FFF" ?>;
}
...
footer , .footer-bottom{background:<?php echo $footer_bg['color'] ?> url('<?php echo $footer_bg['img'] ?>') <?php echo $footer_bg['repeat'] ?> <?php echo $footer_bg['attachment'] ?> <?php echo $footer_bg['hor'] ?> <?php echo $footer_bg['ver'] ?>;}<?php echo "\n"; ?>
<?php endif; ?>
