...
function update_notifier() { 
	...
	<div class="wrap">
	    ...
	    <div id="message" class="updated below-h2"><p><strong>There is a new version of the <?php echo MTHEME_NOTIFIER_THEME_NAME; ?> theme available.</strong> You have version 1.5.0 installed. Update to version <?php echo $xml->latest; ?>.</p></div>
