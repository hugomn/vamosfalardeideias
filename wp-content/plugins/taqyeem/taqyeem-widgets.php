...
class taqyeem_review_widget extends WP_Widget {
	...
	function taqyeem_review_widget() {
		...
		$this->WP_Widget( 'taqyeem-review-widget',TIE_Plugin .' - Review Box', $widget_ops, $control_ops );
	}
...
class taqyeem_get_reviews extends WP_Widget {
	...
	function taqyeem_get_reviews() {
		...
		$this->WP_Widget( 'reviews-posts-widget',TIE_Plugin .' - Reviews Posts', $widget_ops, $control_ops );
	}
...
class taqyeem_types_get_reviews extends WP_Widget {
	...
	function taqyeem_types_get_reviews() {
		...
		$this->WP_Widget( 'reviews-types-widget',TIE_Plugin .' - Reviews Post Types', $widget_ops, $control_ops );
	}
